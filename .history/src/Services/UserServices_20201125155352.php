...
class UserServices 
{
        ...
        private $manager;
        private $encoder;
    public function __construct(EntityManagerInterface $manager, ProfilRepository $profil SerializerInterface $serializer, UserPasswordEncoderInterface $encoder) {
