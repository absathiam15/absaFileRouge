...
class ApprenantController extends AbstractController
{
     ...
     * )
     */
    public function addApprenants(Request $request, ProfilRepository $profilrepo, SerializerInterface $serialize)
    {
                $class="";
        ...
        $app = $this->serialize->denormalize($apprenant, 'App\Entity\Apprenant', true);
