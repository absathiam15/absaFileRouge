...
class UserController extends AbstractController
{
     ...
     */
    public function updateUser(UserRepository $userRepo, $id, Request $request, ProfilRepository $pr EntityManagerInterface $manager, SerializerInterface $serializer){
