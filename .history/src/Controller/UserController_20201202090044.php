...
class UserController extends AbstractController
{
     ...
     */
    public function updateUser(UserRepository $userRepo, $id, Request $request, ProfilRepository $profilR EntityManagerInterface $manager, SerializerInterface $serializer){
        ...
        $data = $this->serializer->denormalize($user, "App\Entity\User");
