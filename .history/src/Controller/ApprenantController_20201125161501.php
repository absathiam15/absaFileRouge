...
class ApprenantController extends AbstractController
{
     ...
     * )
     */
    public function addApprenants(Request $request,EntityManagerInterface ProfilRepository $profilrepo, SerializerInterface $serializer, UserPasswordEncoderInterface $encoder)
    {
                $class="";
