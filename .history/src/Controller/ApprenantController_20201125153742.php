...
class ApprenantController extends AbstractController
{
     ...
     * )
     */
    public function addApprenants(Request $request, ProfilRepository $profilrepo, DenormalizerAwareInterface $denormalis)
    {
        $class="";
        ...
        $app = $this->serializer->denormalize($apprenant, $class, null);
