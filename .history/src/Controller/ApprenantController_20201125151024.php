...
class ApprenantController extends AbstractController
{
     ...
     * )
     */
    public function addApprenants(Request $request, ProfilRepository $profil, EntityManagerInterface $manager)
    {
        $class="";
        $apprenant = $request->request->all();
        $profil = $this->$manager->getProfilRepository(Profil::class)->FindAll();
        dd($profil);
