...
class UserController extends AbstractController
{
     ...
     */
    public function updateUser(UserRepository $userRepo, $id, Request $request, EntityManagerInterface $manager, SerializerInterface){
        ...
        $data = $this->serializer->denormalize($userObjet, "App\Entity\User");
