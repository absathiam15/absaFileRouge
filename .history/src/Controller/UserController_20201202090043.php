...
class UserController extends AbstractController
{
     ...
     */
    public function updateUser(UserRepository $userRepo, $id, Request $request, ProfilRepository $pro EntityManagerInterface $manager, SerializerInterface $serializer){
