...
class ApprenantController extends AbstractController
{
     ...
     * )
     */
    public function addApprenants(Request $request,EntityManagerInterface $m, ProfilRepository $profilrepo, SerializerInterface $serializer, UserPasswordEncoderInterface $encoder)
    {
                $class="";
