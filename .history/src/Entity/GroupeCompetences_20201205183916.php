...
class GroupeCompetences
{
     ...
     * @Groups({"grpComp:write", "grpComp:read", "referentiel:write", "referent:read", "ref:read"})
     */
    private $libelle;

    /**
     * @ORM\Column(type="string", length=200)
     * @Groups({"grpComp:write", "grpComp:read", "referentiel:write", "referentiel:read", "ref:read"})
     */
    private $description;

    /**
     * @ORM\ManyToMany(targetEntity=Competences::class, mappedBy="groupeCompetences", cascade={"persist"})
     * @Groups({"grpComp:write", "grpComp:read", "referentiel:write", "referentiel:read"})
     */
    private $competences;
