...
class Competences
{
     ...
     * @Groups({"comp:read", "comp:write", "grpComp:write", "grpComp:read", "referentiel:write", "referentiel:read"})
     */
    private $libelle;
     ...
     * @Groups({"comp:read", "comp:write", "grpComp:read", "grpComp:write", "referentiel:write", "referentiel:read")
     */
