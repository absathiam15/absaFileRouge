...
class Competences
{
     ...
     * @Groups({"comp:read", "comp:write", "grpComp:read", {
    "@context": "/api/contexts/GroupeCompetences",
    "@id": "/api/grpecompetences/11",
    "@type": "GroupeCompetences",
    "libelle": "Groupe de competences",
    "description": "dev web",
    "competences": [
        {
            "@id": "/api/admin/competences/14",
            "@type": "Competences",
            "libelle": "Developpeur Backend",
            "niveauxEvaluations": []
        }
    ]
}})
