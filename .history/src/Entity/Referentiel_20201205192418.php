 ...
 *          "normalization_context"={"groups"={"read_all"}}
 *        },
 ...
 *      "get_ref_grpeCompet" = {
 *      "method" = "GET",
 *      "path" = "/admin/referentiels/{idr}/grpecompetences/{idc}",
 *      "normalization_context" = {"groups"={"ref_grpCompet_comp"}}
 *    }
 * }
 * )
...
class Referentiel
{
     ...
     * @Groups({"group:read", "referentiel:write", "read_all", "ref:read", "ref_grpCompet_comp"})
     */
    private $libelle;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"group:read", "referentiel:write", "read_all", "ref:read"})
     */
    private $programme;
     ...
     * @Groups({"referentiel:write", "read_all", "ref:read", "ref_grpCompet_comp"})
     */
