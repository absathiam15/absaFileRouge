...
class Competences
{
     ...
     * @Groups({"comp:read", "comp:write", "grpComp:write", "grpComp:read", "referentiel:write", "read_all", "ref_grpCompet_comp"})
     */
    private $libelle;
     ...
     * @Groups({"comp:read", "comp:write", "grpComp:read", "grpComp:write", "referentiel:write", "read_all", "ref_grpCompet_comp"})
     */
