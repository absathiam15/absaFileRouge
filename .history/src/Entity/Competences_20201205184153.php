...
class Competences
{
     ...
     * @Groups({"comp:read", "comp:write", "grpComp:write", "grpComp:read", "referentiel:write", "referent:read_all"})
     */
    private $libelle;
     ...
     * @Groups({"comp:read", "comp:write", "grpComp:read", "grpComp:write", "referentiel:write", "referent:read_all"})
     */
