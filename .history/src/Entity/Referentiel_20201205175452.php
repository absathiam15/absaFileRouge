...
class Referentiel
{
     ...
     * @Groups({"group:read", "referentiel:write", "referentiel:read"})
     */
    private $libelle;
    ...
    /**
     * @ORM\OneToMany(targetEntity=GroupeCompetences::class, mappedBy="referentiel", cascade={"persist"})
     * @Groups({"referentiel:write", "referentiel:read"})
     */
