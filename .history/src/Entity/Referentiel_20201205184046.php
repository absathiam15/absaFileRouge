 ...
 *          "normalization_context"={"groups"={"referent:read_all"}}
 *        },
...
class Referentiel
{
     ...
     * @Groups({"group:read", "referentiel:write", "referent:read_all", "ref:read"})
     */
    private $libelle;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"group:read", "referentiel:write", "referent:read", "ref:read"})
     */
     ...
     * @Groups({"referentiel:write", "referent:read", "ref:read"})
     */
