...
class Promo
{
     ...
     * @Groups({"promo:write", "group:read", "promo:read", "groupe:write"})
     */
    private $id;

    /**
     * @ORM\Column(type="date", nullable=true)
     * @Groups({"promo:write", "promo:read", "referentiel:write"})
     * 
     */
    private $annee;
     ...
     * @Groups({"group:read", "promo:write", "promo:read", "referentiel:write"})
     */
    private $lieuPromo;
    ...
    /**
     * @ORM\Column(type="integer")
     * @Groups({"group:read", "promo:write", "promo:read"})
     */
